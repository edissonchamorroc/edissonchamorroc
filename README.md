...
I have expirience with C++, C#, Java, Spring boot, Spring web, Spring security, Spring JPA, Drupal, IBM Integration, SerenityBDD, Karate and JMeter.


I used to programming in C++, python and Java as tool for microcontrollers. On the other hand, I took some courses in order to improve software knowledge.  
...
### :bar_chart: working:
 ...
 - Using ![ESQL](https://github.com/edissonchamorroc/edissonchamorroc/blob/main/esql.jpg) 
